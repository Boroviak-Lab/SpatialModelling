...
%load('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/NATURE REVISION/Spatial models for revisions/CS5/05 Blender output surfaces/CS5_revisions_HIGHRES.mat','OBJ1')
load('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/NATURE REVISION/Spatial models for revisions/Cross sections/CS5/CS5_revisions_DIAGONAL_2.mat')
O1b = OBJ1_6;
load('./Data/Cross sections/CS6/CS6_revisions_CROSS_246.mat')
[O2b, sectcs6] = LoadCS6('246');
%load('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/NATURE REVISION/Spatial models for revisions/CS6 Replicate Twin (EI)/05 Blender surfaces/CS6_EI_twin_30042_HIGHRES.mat')
%[OBJ2B_3,sections] = LoadCS6_2('D2')
load('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/NATURE REVISION/Spatial models for revisions/CS7/05 Blender surfaces/200319_CS7_build_full_stalkcut_FORDYLAN.mat')
...
%CS5
%O1 = importdata('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/3D_Modellinng/LowRes/CS5HR.mat')
O1.vertices(:,3) = O1.vertices(:,3) -180 ;

%O3.vertices(:,3) = O8.vertices(:,3) - 40;
...
%O2.vertices = Quaternion3(5.3,[0,0,1],O2.vertices); 
...
%CS7
%O3 = importdata('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/3D_Modellinng/LowRes/CS7HR.mat')
%O3.vertices = Quaternion3(4.55,[0,0,1],O3.vertices); 
...
%Preimplantation
%O4 = read_wobj('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/Online Resource/Preimplantation cross sections/Early_blastocyst_CS3.obj')
%O4 = read_wobj('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/Online Resource/Preimplantation cross sections/Late_blastocyst_CS3.obj')

%O4 = load('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/3D_Modellinng/Blender meshes/Blastocyst_halfcut_2.mat')
%O4 =O4.OBJ0
%O4=O5
%O4.vertices = Quaternion3(pi/2,[1,0,0],O4.vertices); 
%O4.vertices = O4.vertices*33.2;

load('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/3D_Modellinng/LowRes/lBlHR.mat')
...
%save('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/3D_Modellinng/LowRes/eBlHR2.mat','O5')
load('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/3D_Modellinng/LowRes/eBlHR2.mat')
%save('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/3D_Modellinng/LowRes/eBlHR.mat','O5')
%O5.vertices = Quaternion3(pi*0.75,[0,1,0],O5.vertices); 
...
load('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/3D_Modellinng/LowRes/cMHR.mat')
...
load('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/3D_Modellinng/LowRes/ECHR.mat')
...
load('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/3D_Modellinng/LowRes/FCHR.mat')
...
%Pre. 1 unit = 16.6 uM. 6.0241 units = 100um. *30 on new scale.
%==180.7229=100. 180.7229==200.
%Post. 1 unit = 0.5 uM. 400==200um.

%Add scale bars
%plot(linspace(1650,1650+361.4458,100)+ DeltaX,600*ones(1,100)+ DeltaY,'k','LineWidth',5)
%text(1655+DeltaX,670+DeltaY,{'200 um'},'FontSize',8)
% plot(linspace(4600,4600+400,100),-400*ones(1,100),'k','LineWidth',5)
% xlim([-850,6000])
% ylim([-800,1900])
...
%print('-dpng',['/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/Online Resource/Plots/All/Lineage_wBG_OFF.png'],'-r1000')
%print('-dpng',['~/Desktop/Lineage_wBG_OFF.png'],'-r1000')


%text(4710,-340,{'200 um'},'FontSize',8)

% %Add labels
%  text(-600+ DeltaX,1300+ DeltaY,{'Zygote'},'FontSize',12)
%  plot(linspace(-310,-360,100)+ DeltaX,linspace(1016,1230,100)+ DeltaY,'k-','LineWidth',1)
%  text(-120+ DeltaX,1300+ DeltaY,{'4-cell'},'FontSize',12)
%  plot(linspace(65,15,100)+ DeltaX,linspace(1030,1230,100)+ DeltaY,'k-','LineWidth',1)
%  text(310+ DeltaX,1300+ DeltaY,{'8-cell'},'FontSize',12)
%  plot(linspace(472,500,100)+ DeltaX,linspace(1065,1230,100)+ DeltaY,'k-','LineWidth',1)
%  text(750+ DeltaX,1300+ DeltaY,{'Morula'},'FontSize',12)
%  plot(linspace(846,906,100)+ DeltaX,linspace(1095,1220,100)+ DeltaY,'k-','LineWidth',1)
%  text(1200+ DeltaX,1300+ DeltaY,{'ICM'},'FontSize',12)
%  plot(linspace(1326,1325,100)+ DeltaX,linspace(1077,1230,100)+ DeltaY,'k-','LineWidth',1)
%  text(1500+ DeltaX,800+ DeltaY,{'Tb'},'FontSize',12)
%  plot(linspace(1320,1480,100)+ DeltaX,linspace(915,850,100)+ DeltaY,'k-','LineWidth',1)
%  text(2000+ DeltaX,800+ DeltaY,{'Tb'},'FontSize',12)
%  plot(linspace(1905,2000,100)+ DeltaX,linspace(882,850,100)+ DeltaY,'k-','LineWidth',1)
%  text(1700+ DeltaX,1300+ DeltaY,{'Epiblast'},'FontSize',12)
%  plot(linspace(1806,1790,100)+ DeltaX,linspace(1124,1240,100)+ DeltaY,'k-','LineWidth',1)
%  text(2100+ DeltaX,1100+ DeltaY,{'Hypoblast'},'FontSize',12)
%  plot(linspace(1932,2090,100)+ DeltaX,linspace(1067,1065,100)+ DeltaY,'k-','LineWidth',1)
%  text(-600,150,{'SYS'},'FontSize',12)
%  plot(linspace(-206,-400,100),linspace(90,130,100),'k-','LineWidth',1)
%  text(-250,250,{'VE'},'FontSize',12)
%  plot(linspace(-94,-200,100),linspace(72,210,100),'k-','LineWidth',1)
%  text(0,200,{'EmDisc'},'FontSize',12)
%  plot(linspace(8,0,100),linspace(1,150,100),'k-','LineWidth',1)
%  text(280,-240,{'Am'},'FontSize',12)
%  plot(linspace(44,250,100),linspace(-63,-200,100),'k-','LineWidth',1)
%  text(-500,-400,{'Tb'},'FontSize',12)
%  plot(linspace(-400,-460,100),linspace(-122,-350,100),'k-','LineWidth',1)
%  text(-110,-360,{'ExMes'},'FontSize',12)
%  plot(linspace(8,0,100),linspace(-101,-310,100),'k-','LineWidth',1)
%  %CS6 labels
%  text(900,-340,{'Tb'},'FontSize',12)
%  plot(linspace(1135,1000,100),linspace(-220,-300,100),'k-','LineWidth',1)
%  text(2000,-300,{'ExMes'},'FontSize',12)
%  plot(linspace(1839,2100,100),linspace(-76,-250,100),'k-','LineWidth',1)
%  text(1700,-400,{'PGC'},'FontSize',12)
%  plot(linspace(1713,1800,100),linspace(-111,-350,100),'k-','LineWidth',1)
%  text(800,200,{'Am'},'FontSize',12)
%  plot(linspace(1158,1000,100),linspace(140,180,100),'k-','LineWidth',1)
%  text(1100,400,{'EmDisc'},'FontSize',12)
%  plot(linspace(1278,1300,100),linspace(178,350,100),'k-','LineWidth',1)
%  text(1600,400,{'SYS'},'FontSize',12)
%  plot(linspace(1572,1600,100),linspace(260,350,100),'k-','LineWidth',1)
%  text(1800,200,{'VE'},'FontSize',12) 
%  plot(linspace(1627,1800,100),linspace(61,200,100),'k-','LineWidth',1)
%  text(2900,-350,{'Tb'},'FontSize',12)
%  plot(linspace(3137,3000,100),linspace(-173,-300,100),'k-','LineWidth',1)
%  
% % 
%  text(5300,600,{'SYS'},'FontSize',12)
%  plot(linspace(5152,5300,100),linspace(557,600,100),'k-','LineWidth',1)
%  text(4200,1500,{'EmDisc'},'FontSize',12)
%  plot(linspace(4234,4300,100),linspace(1147,1450,100),'k-','LineWidth',1)
%  text(2370,480,{'Am'},'FontSize',12)
%  plot(linspace(2690,2500,100),linspace(577,510,100),'k-','LineWidth',1)
%  text(5400,200,{'ExMes'},'FontSize',12)
%  plot(linspace(4843,5400,100),linspace(104,200,100),'k-','LineWidth',1)
% 
%    
%  text(-815,900,{'Carnegie Stage 1'},'FontSize',8)
%  text(83,900,{'Carnegie Stage 2'},'FontSize',8)
%  text(1280,900,{'Carnegie Stage 3'},'FontSize',8)
% 
%  text(-400,-550,{'Carnegie Stage 5'},'FontSize',8)
%  text(1100,-550,{'Carnegie Stage 6'},'FontSize',8)
%  text(3200,-550,{'Carnegie Stage 7'},'FontSize',8)
% 
%  
% xlim([-850,6000])
% ylim([-800,1900])
...
% set(gcf,'PaperUnits','inches','PaperPosition',[0 0 12 12*0.3942])
% 
% %Bounding box for preimp
% %plot(linspace(4843,5400,100),linspace(104,200,100),'k-','LineWidth',1)
% %plot(linspace(-700,2300,100),ones(1,100)*1900,'k','LineWidth',1.5)
% %plot(linspace(-700,2300,100),ones(1,100)*700,'k','LineWidth',1.5)
% %plot(ones(1,100)*2300,linspace(700,1900,100),'k','LineWidth',1.5)
% %plot(ones(1,100)*-700,linspace(700,1900,100),'k','LineWidth',1.5)
% %%Axis properties
% 
% %im2 = imread('/Volumes/GoogleDrive/My Drive/Marmoset_shared_folder/Online Resource/Plots/All/Lineage_wBG.png');
% 
...
% 
% %Now the CS5 only 
% text(-600,150,{'SYS'},'FontSize',22,'Color',[0, 0 ,0])
% hold on
% plot(linspace(-206,-400,100),linspace(90,130,100),'k-','LineWidth',1)
% text(-250,250,{'VE'},'FontSize',22,'Color',[0, 0 ,0])
% plot(linspace(-94,-200,100),linspace(72,210,100),'k-','LineWidth',1)
% text(0,200,{'EmDisc'},'FontSize',22,'Color',[0, 0 ,0])
% plot(linspace(8,0,100),linspace(1,150,100),'k-','LineWidth',1)
% text(280,-240,{'Am'},'FontSize',22,'Color',[0, 0 ,0])
% plot(linspace(44,250,100),linspace(-63,-200,100),'k-','LineWidth',1)
% text(-500,-400,{'Tb'},'FontSize',22,'Color',[0, 0 ,0])
% plot(linspace(-400,-460,100),linspace(-122,-350,100),'k-','LineWidth',1)
% text(-110,-360,{'ExMes'},'FontSize',22,'Color',[0, 0 ,0])
% plot(linspace(8,0,100),linspace(-101,-310,100),'k-','LineWidth',1)
% f1 = patch('Faces',O1.objects(8).data.vertices,'Vertices',O1.vertices,'FaceColor',[12,156,245]/255,'LineStyle','none','FaceAlpha',1);
% f2 = patch('Faces',O1.objects(4).data.vertices,'Vertices',O1.vertices,'FaceColor',[135,123,214]/255,'LineStyle','none','FaceAlpha',1);
% f3 = patch('Faces',O1.objects(20).data.vertices,'Vertices',O1.vertices,'FaceColor',[146,31,230]/255,'LineStyle','none','FaceAlpha',1);
...
% 
% %CS6
% text(900,-340,{'Tb'},'FontSize',22)
% hold on
% plot(linspace(1135,1000,100),linspace(-220,-300,100),'k-','LineWidth',1)
% text(2100,-300,{'ExMes'},'FontSize',22)
% plot(linspace(1839,2100,100),linspace(-76,-250,100),'k-','LineWidth',1)
% text(1700,-400,{'PGC'},'FontSize',22)
% plot(linspace(1713,1800,100),linspace(-111,-350,100),'k-','LineWidth',1)
% text(800,200,{'Am'},'FontSize',22)
% plot(linspace(1158,1000,100),linspace(140,180,100),'k-','LineWidth',1)
% text(1250,400,{'EmDisc'},'FontSize',22)
% plot(linspace(1278,1300,100),linspace(178,350,100),'k-','LineWidth',1)
% text(1600,400,{'SYS'},'FontSize',22)
% plot(linspace(1572,1600,100),linspace(260,350,100),'k-','LineWidth',1)
% text(1800,200,{'VE'},'FontSize',22)
% plot(linspace(1627,1800,100),linspace(61,200,100),'k-','LineWidth',1)
% f1 = patch('Faces',O2.objects(4).data.vertices,'Vertices',O2.vertices,'FaceColor',[95,84,199]/255,'LineStyle','none','FaceAlpha',1);
% f2 = patch('Faces',O2.objects(8).data.vertices,'Vertices',O2.vertices,'FaceColor',[7,103,218]/255,'LineStyle','none','FaceAlpha',1);
% f3 = patch('Faces',O2.objects(12).data.vertices,'Vertices',O2.vertices,'FaceColor',[196,154,0]/255,'LineStyle','none','FaceAlpha',1);
...
% xlim([780 2400])
% ylim([-500 630])
% text(1300,600,{'LINEAGE'},'FontSize',22)
% text(1200,520,{'Carnegie Stage 6'},'FontSize',22)
% set(gca,'XTick',[],'YTick',[],'ZTick',[])
% axis off
% set(gca,'Color','w')
% %Save
...
% 
% %CS7
% text(2900,-370,{'Tb'},'FontSize',22)
% hold on
% plot(linspace(3137,3000,100),linspace(-173,-300,100),'k-','LineWidth',1)
% text(5300,600,{'SYS'},'FontSize',22)
% plot(linspace(5152,5300,100),linspace(557,600,100),'k-','LineWidth',1)
% text(4200,1520,{'EmDisc'},'FontSize',22)
% plot(linspace(4234,4300,100),linspace(1147,1450,100),'k-','LineWidth',1)
% text(2370,450,{'Am'},'FontSize',22)
% plot(linspace(2690,2500,100),linspace(577,510,100),'k-','LineWidth',1)
% text(5400,200,{'ExMes'},'FontSize',22)
% plot(linspace(4843,5400,100),linspace(104,200,100),'k-','LineWidth',1)
% f1 = patch('Faces',O3.objects(4).data.vertices,'Vertices',O3.vertices,'FaceColor',[26,8,115]/255,'LineStyle','none','FaceAlpha',1);
% f2 = patch('Faces',O3.objects(8).data.vertices,'Vertices',O3.vertices,'FaceColor',[2,51,191]/255,'LineStyle','none','FaceAlpha',1);
% f3 = patch('Faces',O3.objects(12).data.vertices,'Vertices',O3.vertices,'FaceColor',[191,113,4]/255,'LineStyle','none','FaceAlpha',1);
...
% text(3400,2220,{'Carnegie Stage 7'},'FontSize',22,'Color',[1, 1 ,1])
% set(gca,'XTick',[],'YTick',[],'ZTick',[])
% axis off
% set(gca,'Color','w')
...
print('-dpng',['~/Desktop//OnlineResource/CS5/Lineage_CS5_bBG_ON.png'],'-r1000')
%print('-dpng',['~/Desktop/Lineage_CS5_bBG_ON.png'],'-r1000')
...
fig=gcf;ax=fig.CurrentAxes;fig.Color='k';fig.OuterPosition=fig.InnerPosition;
axis off
print('-dpng',['~/Desktop/OnlineResource/CS7/Lineage_CS7_bBG_OFF.png'],'-r1000')
%print('-dpng',['~/Desktop/Lineage_CS7_bBG_OFF.png'],'-r1000')
text(2900,-350,{'Tb'},'FontSize',12,'Color',[1, 1 ,1])
hold on
plot(linspace(3147,3000,100),linspace(-143,-300,100),'w-','LineWidth',1)
text(5300,600,{'SYS'},'FontSize',12,'Color',[1, 1 ,1])
...
%D3 = ("/Users/christopherpenfold/Desktop/Thorsten/CombinedModelling/marmoset/featurecountsAll_CAPProcessed.csv",sep=",",header = T, row.names=1)
%Dexp = importdata('/Users/christopherpenfold/Desktop/Thorsten/FINAL/CCAFigForPaper_ClaraSophieAmnioids/Scaled.csv')
%Dexp1 = importdata('/Users/christopherpenfold/Desktop/Thorsten/FINAL/Final_AllGoodShots_wCS6r/NormData.csv');
...
%i=9704
%list = importdata('/Users/christopherpenfold/Desktop/Thorsten/FINAL/IDCorr/Corr_AllGenesEmDisc.csv')
%list = importdata('~/Desktop/MaxGenes.csv')
...
%205
for i = 1:10000%length(genelist2)
close all    
...
%f1 = patch('Faces',O1.objects(8).data.vertices,'Vertices',O1.vertices,'FaceVertexCData',Output1.m_1,'FaceColor','interp','LineStyle','none');
%f2 = patch('Faces',O1.objects(4).data.vertices,'Vertices',O1.vertices,'FaceVertexCData',Output1.m_0,'FaceColor','interp','LineStyle','none');
%f3 = patch('Faces',O1.objects(20).data.vertices,'Vertices',O1.vertices,'FaceVertexCData',Output1.m_5,'FaceColor','interp','LineStyle','none');
%f4 = patch('Faces',O1.objects(24).data.vertices,'Vertices',O1.vertices,'FaceVertexCData',Output1.m_4,'FaceColor','interp','LineStyle','none');
%f5 = patch('Faces',O1.objects(16).data.vertices,'Vertices',O1.vertices,'FaceVertexCData',Output1.m_2,'FaceColor','interp','LineStyle','none');
%f6 = patch('Faces',O1.objects(12).data.vertices,'Vertices',O1.vertices,'FaceVertexCData',Output1.m_3,'FaceColor','interp','LineStyle','none');
%CS6
%Am / 
...
%f1 = patch('Faces',O3.objects(4).data.vertices,'Vertices',O3.vertices,'FaceVertexCData',Output3.m_0,'FaceColor','interp','LineStyle','none');
%f2 = patch('Faces',O3.objects(8).data.vertices,'Vertices',O3.vertices,'FaceVertexCData',Output3.m_1,'FaceColor','interp','LineStyle','none');
%f3 = patch('Faces',O3.objects(12).data.vertices,'Vertices',O3.vertices,'FaceVertexCData',Output3.m_2,'FaceColor','interp','LineStyle','none');
%f5 = patch('Faces',O3.objects(24).data.vertices,'Vertices',O3.vertices,'FaceVertexCData',Output3.m_1,'FaceColor','interp','LineStyle','none');
%f6 = patch('Faces',O3.objects(16).data.vertices,'Vertices',O3.vertices,'FaceVertexCData',Output3.m_5,'FaceColor','interp','LineStyle','none');
...
fig=gcf;ax=fig.CurrentAxes;fig.Color='k';fig.OuterPosition=fig.InnerPosition;
axis off
print('-dpng',['~/Desktop/OnlineResource/All/' genelist{list} '_bBG_OFF.png'],'-r800')
...
text(1100,-550,{'Carnegie Stage 6'},'fontweight','bold','FontSize',12,'Color',[1, 1 ,1])
text(3200,-550,{'Carnegie Stage 7'},'fontweight','bold','FontSize',12,'Color',[1, 1 ,1])
print('-dpng',['~/Desktop/OnlineResource/All/' genelist{list} '_bBG_ON.png'],'-r800')
close all
...
set(gcf,'PaperUnits','inches','PaperPosition',[0 0 8 8])
fig=gcf;ax=fig.CurrentAxes;fig.Color='k';fig.OuterPosition=fig.InnerPosition;
print('-dpng',['~/Desktop/OnlineResource/CS5/' genelist{list} '_CS5_bBG_OFF.png'],'-r800')
...
text(-300,410,{'Carnegie Stage 5'},'fontweight','bold','FontSize',22,'Color',[1, 1 ,1])
print('-dpng',['~/Desktop/OnlineResource/CS5/' genelist{list} '_CS5_bBG_ON.png'],'-r800')
%print('-dpng',['~/Desktop/' list{i} '_CS5_bBG_ON.png'],'-r800')
close all
...
set(gcf,'PaperUnits','inches','PaperPosition',[0 0 8 8])
fig=gcf;ax=fig.CurrentAxes;fig.Color='k';fig.OuterPosition=fig.InnerPosition;
print('-dpng',['~/Desktop/OnlineResource/CS6/' genelist{list} '_CS6_bBG_OFF.png'],'-r800')
...
text(1200,575,{'Carnegie Stage 6'},'fontweight','bold','FontSize',22,'Color',[1, 1 ,1])
print('-dpng',['~/Desktop/OnlineResource/CS6/' genelist{list} '_CS6_bBG_ON.png'],'-r800')
%print('-dpng',['~/Desktop/' list{i} '_CS6_bBG_ON.png'],'-r800')
close all
...
fig=gcf;ax=fig.CurrentAxes;fig.Color='k';fig.OuterPosition=fig.InnerPosition;
axis off
print('-dpng',['~/Desktop/OnlineResource/CS7/' genelist{list} '_CS7_bBG_OFF.png'],'-r800')
%print('-dpng',['~/Desktop/' list{i} '_CS7_bBG_OFF.png'],'-r800')
...
text(3400,2220,{'Carnegie Stage 7'},'fontweight','bold','FontSize',22,'Color',[1, 1 ,1])
print('-dpng',['~/Desktop/OnlineResource/CS7/' genelist{list} '_CS7_bBG_ON.png'],'-r800')
%print('-dpng',['~/Desktop/' list{i} '_CS7_bBG_ON.png'],'-r800')
...
fig=gcf;ax=fig.CurrentAxes;fig.Color='k';fig.OuterPosition=fig.InnerPosition;
axis off
print('-dpng',['~/Desktop/OnlineResource/CS3/' genelist{list} '_CS3_bBG_OFF.png'],'-r800')
%print('-dpng',['~/Desktop/Lineage_CS3_OFF.png'],'-r800')
hold on
...
text(1300,1960,{'Carnegie Stage 3'},'fontweight','bold','FontSize',22,'Color',[1, 1 ,1])
print('-dpng',['~/Desktop/OnlineResource/CS3/' genelist{list} '_CS3_bBG_ON.png'],'-r800')
%print('-dpng',['~/Desktop/Lineage_CS3_ON.png'],'-r800')
...
fig=gcf;ax=fig.CurrentAxes;fig.Color='k';fig.OuterPosition=fig.InnerPosition;
axis off
print('-dpng',['~/Desktop/OnlineResource/CS1-2/' genelist{list} '_CS1-2_bBG_OFF.png'],'-r800')
%print('-dpng',['~/Desktop/Lineage_CS1_bBG_OFF.png'],'-r800')
hold on
...
text(-50,1850,{'Carnegie Stages 1-2'},'fontweight','bold','FontSize',22,'Color',[1, 1 ,1])
print('-dpng',['~/Desktop/OnlineResource/CS1-2/' genelist{list} '_CS1-2_bBG_ON.png'],'-r800')
%print('-dpng',['~/Desktop/Lineage_CS1_bBG_ON.png'],'-r800')
