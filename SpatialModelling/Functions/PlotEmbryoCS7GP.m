function h = PlotEmbryoCS7GP(varargin)
...
f4 = patch('Faces',OBJ2A.objects(30).data.vertices,'Vertices',OBJ2A.vertices,'FaceVertexCData',Output.m2,'FaceColor','interp','LineStyle','none');
end
