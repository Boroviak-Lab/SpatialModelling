function h = PlotEmbryoCS6GP_2_v3(varargin)
...
f4 = patch('Faces',OBJ2A.objects(20).data.vertices,'Vertices',OBJ2A.vertices,'FaceVertexCData',Output.m8,'FaceColor','interp','LineStyle','none');
end
...
f7 = patch('Faces',OBJ2A.objects(24).data.vertices,'Vertices',OBJ2A.vertices,'FaceVertexCData',Output.m7,'FaceColor','interp','LineStyle','none');
end
