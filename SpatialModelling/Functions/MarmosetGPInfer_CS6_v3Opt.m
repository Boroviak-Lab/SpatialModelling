function [Output] = MarmosetGPInfer_CS6_v3Opt(varargin);



%= MarmosetGP_CS7_v3Opt(D,Output,gene2test);

if length(varargin)==6
    Output = varargin{1};
    OBJ = varargin{2};
    gene2test =  varargin{3};
    D = varargin{4};
    theta1 = varargin{5};
    theta2 = varargin{6};
...
Ytrain = D.data(gene2test,Output.cleanindex);

%Xtrain = Output.cleanX / Output.scalefactor;
%Ytrain = Output.Ytrain;

HYP2 = theta1;%Output.HYP1;
HYP3 = theta2;%Output.HYP2;
