function [Dexp1,Arc,Xtest,Output] = loadCS7(D3,Dexp)

fid = fopen('Functions/SmoothSurfaces/CS7/Proj_shots_BLEND_high.csv', 'rt'); 
...
D1_ = importdata('Functions/SmoothSurfaces/CS7/EmDisc_BLEND_points_high_final.csv');
...
D3_ = importdata('Functions/SmoothSurfaces/CS7/Tb_BLEND_faces_high_final.csv');
D4_ = importdata('Functions/SmoothSurfaces/CS7/Am_BLEND_faces_high_final.csv');
D5_ = importdata('Functions/SmoothSurfaces/CS7/sys_BLEND_faces_high_final.csv'); %Trophoblast
D6_ = importdata('Functions/SmoothSurfaces/CS7/ExMes_BLEND_faces_high_final.csv');
D7_ = importdata('Functions/SmoothSurfaces/CS7/ExMes_stalk_BLEND_faces_high_final.csv');
