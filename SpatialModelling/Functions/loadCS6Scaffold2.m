function [Output] = loadCS6Scaffold2(D,Locations,Shots)
...
%ReferenceLocatioins = strrep(ReferenceLocatioins,"E15C2_","E15C_");
%ReferenceLocatioins = strrep(ReferenceLocatioins,"E15C1_","E15C_");
...
%idex = find( strcmp(QCReferenceTypes,'Am_CS6')==1 | strcmp(QCReferenceTypes,'EmDisc_CS6')==1 | strcmp(QCReferenceTypes,'PGC_CS6')==1 | strcmp(QCReferenceTypes,'Stalk_CS6')==1 | strcmp(QCReferenceTypes,'ExMes_CS6')==1 | strcmp(QCReferenceTypes,'SYS_CS6')==1 | strcmp(QCReferenceTypes,'Tb_CS6')==1 | strcmp(QCReferenceTypes,'VE_CS6')==1 );
