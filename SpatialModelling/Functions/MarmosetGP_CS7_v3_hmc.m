function [Output] = MarmosetGP_CS7_v3_hmc(D,Output,gene2test);
...
% options(15) = 0;	    % Number of samples omitted at start of chain.
% options(18) = 0.02;
...
% [samples1, energies1] = hmc2('gpfunc', unwrap(hyp1), options, 'gpgrad', im1, par1{:});     
% [samples2, energies2] = hmc2('gpfunc', unwrap(hyp2), options, 'gpgrad', im2, par2{:});     
