function h = PlotEmbryoCS6GP(varargin)
...
f4 = patch('Faces',OBJ2A.objects(24).data.vertices,'Vertices',OBJ2A.vertices,'FaceVertexCData',Output.m2,'FaceColor','interp','LineStyle','none');
end
