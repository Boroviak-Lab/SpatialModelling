function [Output] = loadCS7ScaffoldCorr(D,Locations,Types,Shots)
...
idex = find( strcmp(QCReferenceTypes,'Am_CS7')==1 | strcmp(QCReferenceTypes,'EmDisc_CS7')==1 | strcmp(QCReferenceTypes,'ExMes_CS7')==1 | strcmp(QCReferenceTypes,'SYS_CS7')==1 | strcmp(QCReferenceTypes,'Tb_CS7')==1 | strcmp(QCReferenceTypes,'VE_CS7')==1 | strcmp(QCReferenceTypes,'EmDisc_stalk_CS7')==1 | strcmp(QCReferenceTypes,'Stalk_CS7')==1 | strcmp(QCReferenceTypes,'ExMes_stalk_CS7')==1);
%idex = find( strcmp(QCReferenceTypes,'Am_CS67')==1 | strcmp(QCReferenceTypes,'EmDisc_CS7')==1 | strcmp(QCReferenceTypes,'PGC_CS7')==1 | strcmp(QCReferenceTypes,'Stalk_CS7')==1 | strcmp(QCReferenceTypes,'ExMes_CS7')==1 | strcmp(QCReferenceTypes,'SYS_CS7')==1 | strcmp(QCReferenceTypes,'Tb_CS7')==1 | strcmp(QCReferenceTypes,'VE_CS7')==1 | strcmp(QCReferenceTypes,'Am_CS7_PGC')==1 | strcmp(QCReferenceTypes,'EmDisc_CS7_PGC')==1 | strcmp(QCReferenceTypes,'EmDisc_Gast_CS7')==1 | strcmp(QCReferenceTypes,'EmDisc_gast_CS7')==1 );
