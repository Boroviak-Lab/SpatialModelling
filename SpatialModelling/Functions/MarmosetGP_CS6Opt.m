function [Output] = MarmosetGP_CS6Opt(D,Output,gene2test);
...
%indT = find(Output.cleanAnotaton=="EmDisc_CS6" | Output.cleanAnotaton=="Stalk_CS6");
par = {@meanConst,@covSEiso,'likGauss',Xtrain(indT,1:3), Ytrain(indT)'};
hyp2 = feval(@minimize, hyp1, @gp, -1000, im1, par{:});         % optimise
hyp3 = feval(@minimize, hyp1B, @gp, -1000, im2, par{:});         % optimise
HYP2{1,2} = hyp2;
...
Output.L2 = [L2_1,L2_2,L2_3,L2_4,L2_5,L2_6,L2_7,L1_8];
Output.HYP1 = HYP2;
Output.HYP2 = HYP3;
