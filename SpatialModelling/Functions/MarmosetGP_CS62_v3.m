function [Output] = MarmosetGP_CS62_v3(D,Output,gene2test);

%Scale the input data
Xtrain = Output.cleanX / 400;
...
%First is amnion
indT = find(strcmp(Output.cleanAnotaton,"Am_CS6")==1);
...
%Second is EmDisk
indT = find(strcmp(Output.cleanAnotaton,"Stalk_CS6")==1);
par = {@meanConst,@covSEiso,'likGauss',Xtrain(indT,1:3), Ytrain(indT)'};
hyp2 = feval(@minimize, hyp1, @gp, -1000, im1, par{:});         % optimise
hyp3 = feval(@minimize, hyp1B, @gp, -1000, im2, par{:});         % optimise
HYP2{1,8} = hyp2;
...
Output.L1 = [L1_1,L1_2,NaN,L1_4,L1_5,L1_6,L1_7,L1_8,L1_9];
Output.L2 = [L2_1,L2_2,NaN,L2_4,L2_5,L2_6,L2_7,L2_8,L2_9];
Output.HYP1 = HYP2;
Output.HYP2 = HYP3;
