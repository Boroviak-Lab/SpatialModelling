function [Output] = MarmosetGP_CS5Corr(Output);
...
[L1(i,8) ] = gp(hyp2, 'infExact', @meanConst, @covSEiso, 'likGauss',  Xtrain(:,1:3), Ytrain');
[L2(i,8) ] = gp(hyp3, 'infExact', @meanConst, @covSEiso, 'likGauss',  Xtrain(:,1:3), Ytrain');
...
%Second is PGC
indT = find(strcmp(Output.cleanAnotaton,"PGC_CS5")==1);
