function [Output] = MarmosetGPInfer_CS6_v3_hmc(varargin);
...
indT = find(Output.cleanAnotaton=="Stalk_CS6" | Output.cleanAnotaton=="EmDisc_Stalk_CS6" | Output.cleanAnotaton=="EmDisc_stalk_CS6");
